    ...
    <div class="container-fluid px-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center flex-wrap gap-2 py-3">
                ...
                <button class="btn btn-light btn-sm text-dark fw-bold px-3 py-2" data-bs-toggle="modal" data-bs-target="#addInventoryModal" style="font-size: 14px;">+ Add Inventory</button>
            </div>
            <div class="card-body">
